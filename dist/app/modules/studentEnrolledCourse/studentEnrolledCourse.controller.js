...
const createStudentEnrolledCourse = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield studentEnrolledCourse_service_1.StudentEnrolledCourseService.createStudentEnrolledCourse(req.body);
...
const getAllStudentEnrolledCourse = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield studentEnrolledCourse_service_1.StudentEnrolledCourseService.getAllStudentEnrolledCourse(filters, options);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
...
const getStudentEnrolledCourse = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const result = yield studentEnrolledCourse_service_1.StudentEnrolledCourseService.getStudentEnrolledCourse(id);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
...
const updateStudentEnrolledCourse = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const result = yield studentEnrolledCourse_service_1.StudentEnrolledCourseService.updateStudentEnrolledCourse(id, req.body);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
