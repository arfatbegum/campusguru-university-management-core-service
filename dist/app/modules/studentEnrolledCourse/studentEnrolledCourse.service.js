...
const createStudentEnrolledCourse = (data) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    ...
    if (result) {
        yield redis_1.RedisClient.publish(studentEnrolledCourse_constants_1.EVENT_STUDENT_ENROLLED_COURSE_CREATED, JSON.stringify(result));
    }
    return result;
});
const getAllStudentEnrolledCourse = (filters, options) => __awaiter(void 0, void 0, void 0, function* () {
...
const getStudentEnrolledCourse = (id) => __awaiter(void 0, void 0, void 0, function* () {
...
const updateStudentEnrolledCourse = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (result) {
        yield redis_1.RedisClient.publish(studentEnrolledCourse_constants_1.EVENT_STUDENT_ENROLLED_COURSE_UPDATED, JSON.stringify(result));
    }
    return result;
});
const deleteStudentEnrolledCourse = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (result) {
        yield redis_1.RedisClient.publish(studentEnrolledCourse_constants_1.EVENT_STUDENT_ENROLLED_COURSE_DELETED, JSON.stringify(result));
    }
    return result;
});
