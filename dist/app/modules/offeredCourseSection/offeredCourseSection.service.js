...
const createOfferedCourseSection = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (result) {
        yield redis_1.RedisClient.publish(offeredCourseSection_constants_1.EVENT_OFFERED_COURSE_SECTIONS_CREATED, JSON.stringify(result));
    }
    return result;
});
const getAllOfferedCourseSection = (filters, options) => __awaiter(void 0, void 0, void 0, function* () {
...
const getOfferedCourseSection = (id) => __awaiter(void 0, void 0, void 0, function* () {
...
const updateOfferedCourseSection = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (result) {
        yield redis_1.RedisClient.publish(offeredCourseSection_constants_1.EVENT_OFFERED_COURSE_SECTIONS_UPDATED, JSON.stringify(result));
    }
    return result;
});
const deleteOfferedCourseSection = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (result) {
        yield redis_1.RedisClient.publish(offeredCourseSection_constants_1.EVENT_OFFERED_COURSE_SECTIONS_DELETED, JSON.stringify(result));
    }
    return result;
});
