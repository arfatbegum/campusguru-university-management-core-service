...
const createSemesterPayment = (prismaClient, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (paymentDetails) {
        yield redis_1.RedisClient.publish(studentSemesterPayment_constants_1.EVENT_SEMESTER_PAYMENT_CREATED, JSON.stringify(paymentDetails));
    }
});
const getAllSemesterPayment = (filters, options) => __awaiter(void 0, void 0, void 0, function* () {
