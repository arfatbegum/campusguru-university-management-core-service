...
const createCourse = (data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const newCourse = yield prisma_1.default.$transaction((transactionClient) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (result) {
            yield redis_1.RedisClient.publish(course_constants_1.EVENT_COURSE_CREATED, JSON.stringify(result));
        }
        return result;
    }));
    if (newCourse) {
...
const updateCourse = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield prisma_1.default.$transaction((transactionClient) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (result) {
            yield redis_1.RedisClient.publish(course_constants_1.EVENT_COURSE_UPDATED, JSON.stringify(result));
        }
        return result;
    }));
    const responseData = yield prisma_1.default.course.findUnique({
...
const deleteCourse = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (result) {
        yield redis_1.RedisClient.publish(course_constants_1.EVENT_COURSE_DELETED, JSON.stringify(result));
    }
    return result;
});
