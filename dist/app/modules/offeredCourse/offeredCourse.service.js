...
const createOfferedCourse = (data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (result) {
        yield redis_1.RedisClient.publish(offeredCourse_constants_1.EVENT_OFFERED_COURSE_CREATED, JSON.stringify(result));
    }
    return result;
});
...
const getOfferedCourse = (id) => __awaiter(void 0, void 0, void 0, function* () {
...
const updateOfferedCourse = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (result) {
        yield redis_1.RedisClient.publish(offeredCourse_constants_1.EVENT_OFFERED_COURSE_UPDATED, JSON.stringify(result));
    }
    return result;
});
const deleteOfferedCourse = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (result) {
        yield redis_1.RedisClient.publish(offeredCourse_constants_1.EVENT_OFFERED_COURSE_DELETED, JSON.stringify(result));
    }
    return result;
});
