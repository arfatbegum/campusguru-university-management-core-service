...
const createStudentEnrolledCourseDefaultMark = (prismaClient, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (markDetails) {
        yield redis_1.RedisClient.publish(studentEnrolledCourseMark_constants_1.EVENT_STUDENT_ENROLLED_COURSE_MARK_CREATED, JSON.stringify(markDetails));
    }
});
const getAllStudentMarks = (filters, options) => __awaiter(void 0, void 0, void 0, function* () {
...
const updateStudentMarks = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (updateStudentMarks) {
        yield redis_1.RedisClient.publish(studentEnrolledCourseMark_constants_1.EVENT_STUDENT_ENROLLED_COURSE_MARK_UPDATED, JSON.stringify(updateStudentMarks));
    }
...
const updateFinalMarks = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (grades) {
        yield redis_1.RedisClient.publish(studentEnrolledCourseMark_constants_1.EVENT_STUDENT_ENROLLED_COURSE_FINAL_MARK_UPDATED, JSON.stringify(grades));
    }
    return grades;
});
