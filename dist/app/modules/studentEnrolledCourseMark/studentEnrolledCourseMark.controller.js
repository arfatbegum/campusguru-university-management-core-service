...
const getAllStudentMarks = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield studentEnrolledCourseMark_service_1.StudentEnrolledCourseMarkService.getAllStudentMarks(filters, options);
