...
const createSemesterRegistration = (data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (result) {
        yield redis_1.RedisClient.publish(semesterRegistration_constants_1.EVENT_SEMESTER_REGISTRATION_CREATED, JSON.stringify(result));
    }
    return result;
});
...
const updateSemesterRegistration = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (result) {
        yield redis_1.RedisClient.publish(semesterRegistration_constants_1.EVENT_SEMESTER_REGISTRATION_UPDATED, JSON.stringify(result));
    }
    return result;
});
const deleteSemesterRegistration = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (result) {
        yield redis_1.RedisClient.publish(semesterRegistration_constants_1.EVENT_SEMESTER_REGISTRATION_DELETED, JSON.stringify(result));
    }
    return result;
});
const startMyRegistration = (authUserId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (result) {
        yield redis_1.RedisClient.publish(semesterRegistration_constants_1.EVENT_SEMESTER_REGISTRATION_STARTED, JSON.stringify(result));
    }
    return result;
});
const enrollIntoCourse = (authUserId, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = studentSemesterRegistrationCourse_service_1.studentSemesterRegistrationCourseService.enrollIntoCourse(authUserId, payload);
    if (result) {
        yield redis_1.RedisClient.publish(semesterRegistration_constants_1.EVENT_ENROLLED_INTO_COURSE, JSON.stringify(result));
    }
    return result;
});
const withdrewFromCourse = (authUserId, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = studentSemesterRegistrationCourse_service_1.studentSemesterRegistrationCourseService.withdrewFromCourse(authUserId, payload);
    if (result) {
        yield redis_1.RedisClient.publish(semesterRegistration_constants_1.EVENT_WITHDREW_FROM_COURSE, JSON.stringify(result));
    }
    return result;
});
const confirmMyRegistration = (authUserId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!semesterRegistration) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, 'No ongoing semester registration found.');
    }
    // 3 - 6
    ...
    yield redis_1.RedisClient.publish(semesterRegistration_constants_1.EVENT_REGISTRATION_CONFIRMATION, JSON.stringify({
        authUserId,
...
const getMyRegistration = (authUserId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield redis_1.RedisClient.publish(semesterRegistration_constants_1.EVENT_REGISTRATION_DETAILS, JSON.stringify({
        authUserId,
        registrationData: { semesterRegistration, studentSemesterRegistration },
    }));
...
const startNewSemester = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // Create a message with semester details
    const semesterDetails = {
        semesterRegistrationId: semesterRegistration.id,
        academicSemesterId: semesterRegistration.academicSemesterId,
    };
    if (semesterDetails) {
        yield redis_1.RedisClient.publish(semesterRegistration_constants_1.EVENT_NEW_SEMESTER_STARTED, JSON.stringify(semesterDetails));
    }
    return {
        message: 'Semester started successfully!',
    };
});
const getMySemesterRegisterCourses = (authUserId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (availableCourses) {
        yield redis_1.RedisClient.publish(semesterRegistration_constants_1.EVENT_AVAILABLE_COURSES, JSON.stringify(availableCourses));
    }
