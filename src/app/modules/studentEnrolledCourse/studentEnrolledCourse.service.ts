...
const getStudentEnrolledCourse = async (id: string): Promise<StudentEnrolledCourse | null> => {
...
const deleteStudentEnrolledCourse = async (id: string): Promise<StudentEnrolledCourse> => {
